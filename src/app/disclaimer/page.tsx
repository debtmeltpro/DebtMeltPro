...
export const metadata: Metadata = {
  title: 'Disclaimer — DebtFreedom',
  description:
    'Financial disclaimer for DebtFreedom calculators. Our tools are for educational purposes only and do not constitute financial, tax, or legal advice.',
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-8 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
          <section>
            ...
            <p>
              All calculators on DebtFreedom — including but not limited to the Debt Payoff Calculator,
          ...
          <section>
            ...
            <p>
              Using DebtFreedom does not create a client, fiduciary, advisory, or professional
              relationship between you and DebtFreedom or its operators. We are not registered
          ...
          <section>
            ...
            <p>
              DebtFreedom displays advertisements served by Google AdSense. These advertisements are
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by applicable law, DebtFreedom and its operators,
