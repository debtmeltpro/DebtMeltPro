...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    metaTitle: 'Compound Interest & FIRE Calculator — Free Investment Growth Tool (2026)',
    metaDescription: 'Free compound interest calculator with FIRE number projection and inflation adjustment. See investment growth, total returns, and your financial independence date. Works in $, ₹, €.',
    keywords: ['compound interest calculator', 'FIRE calculator', 'investment growth calculator', 'financial independence retire early', 'FIRE number calculator', '4 percent rule calculator'],
    category: 'investing',
    icon: 'Flame',
  ...
  },
  {
    ...
    shortTitle: 'SIP',
    description: 'Project mutual fund SIP returns with optional annual step-up. See maturity corpus, total invested, and wealth gained.',
    metaTitle: 'SIP Calculator — Free Systematic Investment Plan Returns (2026)',
    metaDescription: 'Free SIP calculator for mutual fund investments. Enter monthly SIP, expected return, and tenure to see maturity amount, total invested, and returns. Works in ₹, $, €.',
    keywords: ['SIP calculator', 'systematic investment plan calculator', 'mutual fund SIP calculator', 'SIP return calculator', 'monthly SIP calculator'],
    category: 'investing',
    icon: 'PiggyBank',
  ...
  },
  {
    ...
    shortTitle: 'EMI',
    description: 'Calculate loan EMI instantly. See monthly payment, total interest, and full amortization breakdown for home, car, or personal loans.',
    metaTitle: 'EMI Calculator — Free Loan EMI Calculator with Amortization (2026)',
    metaDescription: 'Free EMI calculator for home, car, and personal loans. Enter loan amount, interest rate, and tenure to get monthly EMI, total interest, and payment schedule.',
    keywords: ['EMI calculator', 'loan EMI calculator', 'home loan EMI calculator', 'car loan EMI calculator', 'monthly EMI calculator'],
    category: 'loans',
    icon: 'Calculator',
  ...
  },
  {
    ...
    shortTitle: 'Loan',
    description: 'Full loan amortization with prepayment modeling. Compare standard vs accelerated payoff and see interest saved.',
    metaTitle: 'Loan Calculator — Amortization Schedule & Prepayment Analysis (2026)',
    metaDescription: 'Free loan calculator with full amortization schedule, prepayment impact, and interest savings. Model extra payments on home, auto, or personal loans.',
    keywords: ['loan calculator', 'loan amortization calculator', 'loan repayment calculator', 'loan prepayment calculator', 'personal loan calculator'],
    category: 'loans',
    icon: 'Landmark',
  ...
  },
  {
    ...
    shortTitle: 'CC Interest',
    description: 'See exactly how much interest your credit card balance costs per day, month, and year — plus payoff timeline at any payment.',
    metaTitle: 'Credit Card Interest Calculator — Daily & Monthly Interest Cost (2026)',
    metaDescription: 'Free credit card interest calculator. See daily, monthly, and annual interest charges on your balance, plus total interest paid over your payoff timeline.',
    keywords: ['credit card interest calculator', 'credit card interest rate calculator', 'how much interest on credit card', 'credit card daily interest calculator', 'APR interest calculator'],
    category: 'debt-management',
    icon: 'Percent',
...
export const CATEGORIES: CategoryDef[] = [
  {
    ...
    toolSlugs: ['debt-payoff', 'credit-card-payoff', 'credit-card-interest'],
  ...
  },
  {
    ...
    toolSlugs: ['compound-interest', 'sip-calculator'],
  ...
  },
  {
    ...
    metaTitle: 'Free Loan & EMI Calculators — Amortization & Prepayment',
    metaDescription: 'Free loan and EMI calculators for home, car, and personal loans. Calculate monthly EMI, total interest, amortization schedules, and prepayment savings.',
    description: 'Calculate loan EMIs, compare repayment scenarios, and model prepayments with our free loan calculators.',
    keywords: ['EMI calculator', 'loan calculator', 'loan amortization', 'home loan EMI', 'personal loan calculator'],
    toolSlugs: ['emi-calculator', 'loan-calculator', 'student-loan'],
    introContent: 'Whether you are taking a home loan, financing a car, or consolidating personal debt, understanding your EMI and total interest cost is essential before you sign. Our free loan calculators use standard banking amortization formulas to show your exact monthly payment, total interest over the loan life, and how extra prepayments accelerate payoff. Compare standard repayment against accelerated scenarios to see how even small additional payments can save thousands in interest and shave years off your loan term.',
  },
  {
    slug: 'student-loans',
