...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    metaTitle: 'FIRE Number Calculator — Financial Independence Planner',
  ...
  },
  {
    ...
    metaTitle: 'Credit Card Payoff Calculator — Escape Minimum Payments',
    metaDescription: 'See exactly how long minimum payments take. Our free calculator shows you how to pay off credit card debt years faster and save thousands in interest.',
