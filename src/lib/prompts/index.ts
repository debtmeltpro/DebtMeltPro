...
export const PROMPT_CATEGORIES: PromptCategoryDef[] = [
  ...
  },
  {
    ...
    metaTitle: 'Best ChatGPT Real Estate Prompts 2026 — Free Copy-Paste Templates',
    metaDescription: 'Copy-paste ChatGPT and Claude prompts for rent vs buy, mortgage analysis, and property investment. Free, no signup. Battle-tested templates.',    description: 'AI prompts for home buying decisions, mortgage analysis, rental property evaluation, and real estate negotiation.',
